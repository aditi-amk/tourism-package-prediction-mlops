...
#     st.sidebar.info("📁 Falling back to local model 'best_tourism_project_model_v1.joblib'")
#     try:
#         model = joblib.load("best_tourism_project_model_v1.joblib")
#         st.sidebar.success("✅ Local model loaded")
#         return model
#     except Exception as e_local:
#         st.sidebar.error(f"❌ Local model load failed: {e_local}")
#         st.stop()

# Use the model
# model = load_model()
# model = joblib.load("tourism_project/deployment/best_tourism_project_model_v1.joblib")
